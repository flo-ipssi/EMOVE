    	...
    	<div class="row">
        	<div class="col-sm-3">
            	...
            	<ul class="list-group">
                	...
                	<a href="#" class="list-group-item text-right"><span class="pull-left"><strong>Vos commmandes</strong></span></a>
                	<a href="#" class="list-group-item text-right"><span class="pull-left"><strong class="">Vos avantages</strong></span></a>
                	<a href="#" class="list-group-item text-right"><span class="pull-left"><strong class="">Favoris</strong></span></a>
            	</ul>
                <ul class="list-group">
                	<li class="list-group-item text-muted">Paramètre du compte <i class="fa fa-address-card-o" aria-hidden="true"></i></li>
                	<a href="#" class="list-group-item text-right"><span class="pull-left"><strong class="">Connexion</strong></span></a>
                	<a href="#" class="list-group-item text-right"><span class="pull-left"><strong class="">Informations personnelles</strong></span></a>
                    <a href="#" class="list-group-item text-right"><span class="pull-left"><strong class="">Bon Plans</strong></span></a>
            	</ul>
        	</div>
	        <!--/col-3-->
