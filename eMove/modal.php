    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form role="form" action="" method="post" id="login-connexion" autocomplete="off">
          ...
          <input type="submit" id="btn-connexion" class="btn btn-custom btn-lg btn-block" value="Connexion">
        </form>
    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form role="form" action="" method="post" id="login-inscription" autocomplete="off">
          ...
          <input type="submit" id="btn-inscription" class="btn btn-custom btn-lg btn-block" value="Inscription">
        </form>
      </div>
      <div class="modal-footer">
        <div class="container">
